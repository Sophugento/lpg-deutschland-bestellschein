...
const DE_ALIASES: Record<string, string> = {
  "BODY SHAPING GEL": "GEL LIPORÉDUCTEUR",
  "BODY SHAPING CREAM": "CRÈME LIPORÉDUCTEUR",
  "ANTI-CELLULITE CREAM-IN-GEL": "GEL-CRÈME ANTI CELLULITE",
  "ANTI-CELLULITE INTENSIVE SERUM": "SÉRUM INTENSIF ANTI-CELLULITE",
  "RESURFACING CREAM": "CRÈME MICRO PEELING",
  "FIRMING SHAPING CREAM": "CRÈME FERMETÉ GALBANTE",
  "EXPERT STRETCH MARK OIL": "HUILE EXPERTE VERGETURES",
  "EXPERT CLEANSING BALM": "BAUME DÉMAQUILLANT",
  "PREPARING MICELLAR WATER": "EAU MICELLAIRE PRÉPARATRICE",
  "EXFOLIATING CREAM": "CRÈME EXFOLIANTE",
  "ACTIVE REPLENISHING ESSENCE": "ESSENCE ACTIVE RÉHYDRATANTE",
  "MICRO EXFOLIATING SILKY POWDER": "POUDRE SOYEUSE MICRO EXFOLIANTE",
  "SMOOTHING FILLER MILK SERUM": "SÉRUM LACTÉ LISSANT REPULPANT",
  "OIL-IN-WATER REPLENISHING SERUM": "SÉRUM HUILE-EN-EAU RÉHYDRATANT",
  "FIRMING LIFT SERUM": "SÉRUM LIFT RAFFERMISSANT",
  "SMOOTHING FILLER CREAM": "CRÈME LISSANTE REPULPANTE",
  "SMOOTHING FILLER GEL-CREAM": "GEL-CRÈME LISSANTE REPULPANTE",
  "DYNAMIC REPLENISHING GEL CREAM": "GEL-CRÈME DYNAMISANT RÉHYDRATANT",
  "DYNAMIC REPLENISHING RICH CREAM": "CRÈME RICHE DYNAMISANTE RÉHYDRATANTE",
  "DYNAMIC REPLENISHING CRYO MASK": "MASQUES CRYO DYNA RÉHYDRA",
  "FIRMING LIFT CREAM": "CRÈME LIFT RAFFERMISSANTE",
  "ANTI-FATIGUE REGENERATING NIGHT CREAM": "SOIN NUIT RÉGÉNÉRANT SUBLIMATEUR",
  "RESURFACING GLYCOLIC NIGHT CREAM": "SOIN NUIT GLYCOLIQUE RESURFAÇANT",
  "EYE CREAM": "CRÈME YEUX",
  "EYE BALM": "BAUME YEUX",
  "EYE LIFT TREATMENT": "SOIN REGARD",
  "CELLULAR DEFENSE UV+ FLUID SPF50+": "FLUIDE UV+ DÉFENSE CELLULAIRE",
  "REGENERATING HAND CREAM": "CRÈME MAINS RÉGÉNÉRANTE",
  "ORANGE PEEL NO MORE": "STOP PEAU D'ORANGE",
  "FLUID MOBILISING CONCENTRATE": "CONCENTRÉ DRAINANT",
  "VITALITY BOOSTER": "BOOSTER DE VITALITÉ",
  "FAT-BURNING CONCENTRATE": "CONCENTRÉ BRÛLE-GRAISSES",
  "HYALURONIC ACID": "ACIDE HYALURONIQUE",
  "COLLAGEN": "COLLAGÈNE",
  "OMEGAS 3,6,9": "OMÉGA",
  "EXPRESS BIO-SLIMMING TEA": "THÉ BIO MINCEUR EXPRESS",
  "SOS FAT & SUGAR CONTROL": "SOS PETITS ÉCARTS — ÉDITION LIMITÉE",
  "STRESS & SLEEP COMPLEX": "TISANE STRESS SOMMEIL",
  "APPETITE CONTROL": "RÉDUCTEUR D'APPÉTIT",
  "ENDERMOWEAR WEISS — Gr. M": "ENDERMOWEAR BLANC — T.1 / M",
  "ENDERMOWEAR WEISS — Gr. L": "ENDERMOWEAR BLANC — T.2 / L",
  "ENDERMOWEAR WEISS — Gr. XL": "ENDERMOWEAR BLANC — T.3 / XL",
  "ENDERMOWEAR WEISS — Gr. XXL": "ENDERMOWEAR BLANC — T.4 / XXL",
  "ENDERMOWEAR MEN - GRAU": "ENDERMOWEAR HOMME — GRIS",
  "BOX 6x FILTER": "BOX 6x FILTRE",
  "LIEGENAUFLAGE (ROLLE)": "ROULEAU PROTECTION JETABLE",
  "LPG SHOPPING BAGS LARGE": "SAC LPG GRAND (x10)",
  "LPG SHOPPING BAGS SMALL": "SAC LPG PETIT (x10)",
  "SCHWARZE TUNIKA — S/36": "TUNIQUE NOIRE — S/36",
  "SCHWARZE TUNIKA — M/38": "TUNIQUE NOIRE — M/38",
  "SCHWARZE TUNIKA — L/40": "TUNIQUE NOIRE — L/40",
  "SCHWARZE TUNIKA — XL/42": "TUNIQUE NOIRE — XL/42",
  "WEISSE TUNIKA — S/36": "TUNIQUE BLANCHE — S/36",
  "WEISSE TUNIKA — M/38": "TUNIQUE BLANCHE — M/38",
  "WEISSE TUNIKA — L/40": "TUNIQUE BLANCHE — L/40",
  "WEISSE TUNIKA — XL/42": "TUNIQUE BLANCHE — XL/42",
  "BADEMANTEL 100% BAUMWOLLE — M": "PEIGNOIR 100% COTON — M",
  "BADEMANTEL 100% BAUMWOLLE — L": "PEIGNOIR 100% COTON — L",
  "BADEMANTEL 100% BAUMWOLLE — XL": "PEIGNOIR 100% COTON — XL",
  "LPG BADGE": "BADGE LPG",
...
for (const [en, fr] of Object.entries(DE_ALIASES)) {
  if (PRODUCT_INFO[fr]) PRODUCT_INFO[en] = PRODUCT_INFO[fr];
}
